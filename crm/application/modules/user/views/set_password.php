                ...
                <form class="createaccount" action="<?php echo base_url() . 'user/reset_password' ?>" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" id="password1" name="password_confirmation" class="form-control"
                               placeholder="new password..." data-validation="required"/>
                    </div>
                    <div class="form-group">
                        <input type="password" id="password2" name="password" class="form-control"
                               placeholder="confirm Password" data-validation="confirmation"/>
                    </div>
                    <div>
                        <button type="submit" name="sub" value="Set password" class="btn btn-default green-btn submit">
                            Set password
                        </button>
