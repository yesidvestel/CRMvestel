...
<head>
    ...
    <title>Acta de Transferencia de Equipos #<?php echo $id_acta ?></title>
    <style>	
        body {
            color: #2B2000;
...
<div class="invoice-box">
    <table>
        <tr>
            <td class="myco">
                <img src="<?php echo FCPATH . '../actas/userfiles/company' . $this->config->item('logo') ?>" style="max-width:260px;">
            </td>
            <td>
			...
			<table class="top_sum">
                <tr>
                       <td colspan="1" class="t_center"><h2 ><?php echo "Acta de Transferencia de Equipos" ?></h2><br><br></td>
                    </tr>
			<tr>
                    ...
                    <td align="right">Entregado a:<br>
                        <?php if($almacen_destino->id_tecnico!=null) { ?>
                            ...
                            <?php  if($acta->estado=="Recibida") {?>
                                <img width="30%" alt="signature" class="height-50" src="<?=  FCPATH . '../actas/userfiles/employee_sign' . $almacen_destino->id_tecnico->sign ?>"><br>
