                ...
                <div id="invoice-template" class="card-block">
                                ...
                                <div class="btn-group ">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                           href="<?php echo '../redes/printacta?id=' . $id_acta; ?>"><?php echo $this->lang->line('Print') ?></a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="<?php echo '../redes/printacta?id=' . $id_acta; ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
										<div class="dropdown-divider"></div>
                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                            <h2>Acta de Transferencia de Equipos</h2>
                            <p class="pb-1"> <?php echo  "ACTA#". $id_acta . '</p>'?>
                            <p class="pb-1">Almacen Origen: <?=$almacen_origen->almacen ?></p>
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                            <ul class="px-0 list-unstyled">
                                        ...
                                        <?php }else{ ?>
                                            <a href="#" class="invoice_a"><?=$almacen_destino->almacen ?></a>
											<li>
                            ...
                            <div class="table-responsive col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>Codigo</th>
                                        <th class="text-xs-left">Serial</th>
                                        <th class="text-xs-left">Mac</th>
