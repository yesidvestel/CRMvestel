        ...
        <div class="content-header">
            <div class="card-header">
				...
				<div class="col-xl-12 col-lg-12"><!-- ['y','z','a','b','c','d','e','f','g','h','i','j'] -->
					...
					<input type="checkbox" id="Revision" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'e');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('Revision','e');"><i>&nbsp;Revision Tv+Internet&nbsp;</b></i>
					<input type="checkbox" id="Revision_tv" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'k');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('Revision_tv','k');"><i>&nbsp;Revision Tv&nbsp;</b></i>
					<input type="checkbox" id="Revision_internet" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'l');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('Revision_internet','l');"><i>&nbsp;Revision Internet&nbsp;</b></i>
					...
					<input type="checkbox" id="Corte_Internet" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'m');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('Corte_Internet','m');"><i>&nbsp;Cortes Internet&nbsp;</b></i>
					<input type="checkbox" id="Corte_tv_e_internet" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'n');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('Corte_tv_e_internet','n');"><i>&nbsp;Cortes Tv+Internet&nbsp;</b></i>
					<input type="checkbox" id="migracion" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'o');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('migracion','o');"><i>&nbsp;Migracion&nbsp;</b></i>
					<input type="checkbox" id="punto_nuevo" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'o2');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('punto_nuevo','o2');"><i>&nbsp;Punto Nuevo&nbsp;</b></i>
					<input type="checkbox" id="recuperacion_cable_modem" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'p');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('recuperacion_cable_modem','p');"><i>&nbsp;Rec. Cable modem&nbsp;</b></i>
					<input type="checkbox" id="veeduria" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'q');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('veeduria','q');"><i>&nbsp;Veeduria&nbsp;</b></i>
					<input type="checkbox" id="activacion" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'r');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('activacion','r');"><i>&nbsp;Activacion&nbsp;</b></i>
					<input type="checkbox" id="cambio_de_equipo" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'s');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('cambio_de_equipo','s');"><i>&nbsp;Cambio de Equipo&nbsp;</b></i>
					<input type="checkbox" id="equipo_adicional" style="cursor:pointer;" onclick="activar_desactivar_meses(null,'t');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_meses('equipo_adicional','t');"><i>&nbsp;Equipo Adicional&nbsp;</b></i>
        ...
        <div class="content-body"><!-- stats -->
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
					...
					<input type="checkbox" id="instalaciones_Revision" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'e');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Revision','e');"><i>&nbsp;Revision Tv+Internet&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_Revision_tv" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'e');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Revision_tv','k');"><i>&nbsp;Revision Tv&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_Revision_internet" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'e');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Revision_internet','l');"><i>&nbsp;Revision Internet&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_Reconexion" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'f');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Reconexion','f');"><i>&nbsp;Reconexion Tv+Internet&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_Reconexion_tv" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'f2');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Reconexion_tv','f2');"><i>&nbsp;Reconexion Tv&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_Reconexion_internet" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'f3');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Reconexion_internet','f3');"><i>&nbsp;Reconexion Internet&nbsp;</b></i>
					...
					<input type="checkbox" id="instalaciones_Corte_Internet" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'m');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Corte_Internet','m');"><i>&nbsp;Cortes Internet&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_Corte_tv_e_internet" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'n');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_Corte_tv_e_internet','n');"><i>&nbsp;Cortes Tv+Internet&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_migracion" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'o');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_migracion','o');"><i>&nbsp;Migracion&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_punto_nuevo" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'o2');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_punto_nuevo','o2');"><i>&nbsp;Punto Nuevo&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_recuperacion_cable_modem" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'p');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_recuperacion_cable_modem','p');"><i>&nbsp;Rec. Cable modem&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_veeduria" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'q');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_veeduria','q');"><i>&nbsp;Veeduria&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_activacion" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'r');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_activacion','r');"><i>&nbsp;Activacion&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_cambio_de_equipo" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'s');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_cambio_de_equipo','s');"><i>&nbsp;Cambio de Equipo&nbsp;</b></i>
					<input type="checkbox" id="instalaciones_equipo_adicional" style="cursor:pointer;" onclick="activar_desactivar_lines(null,'t');" class="case"><b style="cursor:pointer;" onclick="activar_desactivar_lines('instalaciones_equipo_adicional','t');"><i>&nbsp;Equipo Adicional&nbsp;</b></i>
