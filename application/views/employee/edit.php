                    ...
                    <td style="border: orange double 1px;vertical-align: top;">
                        <div class="tres_view">
                          <ul>
                            ...
                            <li data-jstree='{"icon":"btn btn-primary <?=$mod->icono?>"}'>&nbsp;<?=$mod->nombre  ?>&nbsp;&nbsp;<input <?=($modulos_usuario[$mod->codigo]==null) ? '':'checked' ?> class="checkbox_modulos" type="checkbox" name="<?=$mod->codigo  ?>" id="<?=$mod->id_modulo  ?>">
                              <ul>
                                ...
                                <?php foreach ($lista_de_hijos as $keyh => $hijo) {?>
                                    <li><input <?=($modulos_usuario[$hijo->codigo]==null) ? '':'checked' ?> class="checkbox_modulos" type="checkbox" name="<?=$hijo->codigo ?>" id="<?=$hijo->id_modulo ?>">&nbsp;<?=$hijo->nombre  ?></li>
                                <?php } ?>
                              </ul>
                            </li>
                          </ul>
