			...
			<table width="100%">
				<tbody>
					<tr>
						...
						<td class="end1" style="width: 25%">
							<h2>CONTRATO ÚNICO DE <br>SERVICIOS FIJOS </h2>No. <span style="border-bottom: 1px solid;"><?php echo $details['documento'] ?></span>
						</td>
					...
					<tr>
						...
						<td align="left" style="width: 30%"><br><br><br><br>
							<h1 align="center"><?php echo $this->config->item('ctitle') ?></h1>
						</td>
					...
					<tr>
						<td colspan="2" style="text-align: justify">
							...
							Internet fijo Televisión Servicios adicionales <span style="border-bottom: 1px solid;"><?php if ($servicios['television'] !== "no") {
																														echo $servicios['television'];
																													}
																													if ($servicios['combo'] !== "no") {
																														echo ' + ' . $servicios['combo'];
																													}
																													if ($servicios['puntos'] !== '0') {
																														echo ' + ' . $servicios['puntos'] . ' Puntos';
																													} ?></span>
						...
						<td colspan="2">
							<table width="100%" border="1">
								<tbody>
									<tr>
										<td align="center"><?php if (file_exists($url_firma)) { ?><img height="130px" src="<?= $url_firma ?>"></img><?php }
																																				if (file_exists($url_huella)) { ?><img height="130px" src="<?= $url_huella ?>"></img><?php } ?><br>Con esta firma acepta recibir la factura solo por medios electrónicos</td>
									</tr>
								</tbody>
							</table>
						...
						<td colspan="2">
							<table width="100%" border="1">
								<tbody>
									...
									<tr>
										<td valign="bottom" align="center"><?php if (file_exists($url_firma)) { ?><img height="130px" src="<?= $url_firma ?>"></img><?php }
																																								if (file_exists($url_huella)) { ?><img height="130px" src="<?= $url_huella ?>"></img><?php } ?><br>Aceptación contrato mediante firma o cualquier otro medio válido</td>
									</tr>
								</tbody>
							</table>
	...
	?>
		<div class="invoice-box">
				...
				<tbody>
					<tr>
						<td style="font-size: 30px; text-align: justify;" width="850px"> <!--COLUMNA IZQUIERDA-->
							<table width="100%" style="page-break-inside: avoid;">
								<tr>
									<td style="text-align: right">
										<h2>CONTRATO ÚNICO DE <br>SERVICIOS FIJOS </h2>No. <span style="border-bottom: 1px solid;"><?php echo $details['abonado'] ?></span>
									</td>
								</tr>
							</table>
							<table width="100%" style="page-break-inside: avoid;">
							...
							<table>
								<tr>
									...
									<td align="left" valign="middle"><br><br><br>
										<h1>OTTIS COMUNICACIONES</h1>
									</td>
								</tr>
							</table>
						...
						$tv='';
											...
											c. Facturación mes presente. La factura se envía por correo electrónico dentro de los 10 primeros días y la misma tiene fecha de <strong>vencimiento el día 25 del mes facturado</strong> y puede realizar el pago a través de los medios
											informados en nuestra página web www.ottis.com.co.<br>
											d. El costo de la instalación en caso de aplicar consiste en la habilitación del servicio y las obras civiles básicas que se requieran (entrega de equipo de
											comunicaciones en calidad de comodato, instalación de mástil o herrajes, fibra óptica, cableado interno a primer equipo, etc.)<br>
											e. El soporte técnico es prestado de forma personalizada, con atención telefónica de Lunes a Viernes de 6am a 10pm, Sábado de 6am a 9pm y domingos y festivos de 9am a 5pm. El soporte técnico en sitio es de lunes a sábado de 8am a 5pm.
										</td>
									<tr>
										<td style="font-size: 20px;line-height: inherit">
			...
			<td style="font-size: 27px; text-align: justify; line-height: 1.5;" width="850px"><!--COLUMNA DERECHO-->
				<h4>PRINCIPALES OBLIGACIONES DEL USUARIO</h4>
				1) Pagar oportunamente los servicios prestados, incluyendolosinteresesdemora cuando haya incumplimiento<br>
				2) Suministrar información verdadera;<br>
				3) Hacer uso adecuado de los equipos y los servicios;<br>
				...
				<h4>CALIDAD Y COMPENSACIÓN</h4>
				Cuando se presente indisponibilidad del servicio superior al ANScontratadooel servicio se suspenda a pesar de su pago oportuno, lo compensaremosensupróxima factura. Debemos cumplir con las condiciones de calidaddefinidasporla CRC. Consúltelas en la página: www.ottis.com.co.
				<h4>CESIÓN</h4>
				Si desea ceder este contrato a otra persona, debe presentar unasolicitudporescrito a través de nuestros Medios de Atención, acompañadadelaaceptación por escrito de la persona a la que se hará la cesión. Dentrodelos15 días hábiles siguientes, analizaremos su solicitud y ledaremosunarespuesta. Si se acepta la cesión queda liberado de cualquier responsabilidadcon nosotros.
				<h4>MODIFICACIÓN</h4>
				Nosotros no podemos modificar el contrato sin su autorización. Estoincluyeque no podemos cobrarle servicios que no haya aceptadoexpresamente.Siesto ocurre tiene derecho a terminar el contrato, inclusoestandovigentelacláusula de permanencia mínima, sin la obligación de pagar sumaalgunaporeste concepto. No obstante, usted puede en cualquier momentomodificarlosservicios contratados. Dicha modificación se hará efectiva en el período de facturaciónsiguiente,para lo cual deberá presentar la solicitud de modificación por lomenoscon3días hábiles de anterioridad al corte de facturación.
				<h4>SUSPENSIÓN</h4>
				Usted tiene derecho a solicitar la suspensión del servicio por unmáximode2meses durante la vigencia del contrato. Para esto debe presentar lasolicitudantes del inicio del ciclo de facturación que desea suspender. Si existeunacláusula de permanencia mínima, su vigencia se prorrogará por el tiempoquedure la suspensión.
				<h4>TERMINACIÓN</h4>
				Usted puede terminar el contrato en cualquier momento sinpenalidades.Paraesto debe realizar una solicitud a través de correo electrónicoal buzón <span style="border-bottom: 1px solid;">comercial@ottis.com.co</span> o radicando la solicitud en la oficinafísicamínimo3días hábiles antes del corte de facturación (su corte de facturaciónesel día30de cada mes). Si presenta la solicitud con una anticipaciónmenor,laterminación del servicio se dará en el siguiente periodo de facturación. Así mismo, usted puede cancelar cualquiera de los servicios contratados,paralo que le informaremos las condiciones en las que serán prestadoslosserviciosno cancelados y actualizaremos el contrato. Así mismo, si el operadornoiniciala prestación del servicio en el plazo acordado, usted puede pedir larestituciónde su dinero y la terminación del contrato.
			</td>
			</tr>
			</table>
			<table width="100%"><!--hoja 2-->
				<tr>
						...
						<table border="1">
							<tr>
								...
								<td>
									...
									a. Oficinas físicas: Calle 13A No. 14-60 Sogamoso, Boyacá - Calle 16 No. 13-44 Local 113A Centro Comercial Cosmocentro La 16, Duitama, Boyacá<br>
									b. Página web www.ottis.com.co<br>
									c. Redes sociales @ottiscomunica<br>
									d. Líneas telefónicas fija (PBX): (601) 9172166 - (601) 7943254.<br>
							...
							<tr>
								...
								<td>
									Presente cualquier queja, petición / reclamo o recurso a través de estos medios y le responderemos en máximo 15 días hábiles.
								</td>
							</tr>
							<tr>
								<td style="background-color: black; color: white; font-size: x-large; text-align: center">
								...
								<td>
									Si no respondemos es porque aceptamos su petición o reclamo. Esto se llama silencio administrativo positivo y aplica para internet y telefonía.
								</td>
							</tr>
						</table>
						<br>
					...
					<td width="850px" style="font-size: 30px;line-height: normal;text-align: justify"><!--COLUMNA DERECHO-->
						...
						Usted puede cambiar de domicilio y continuar con el servicio siempre que sea técnicamente posible. Si desde el punto de vista técnicono es viable el traslado del servicio, usted puede ceder su contratoauntercerooterminarlo pagando el valor de la cláusula de permanencia mínima si está vigente.
						<br>
						<h4>LARGA DISTANCIA (TELEFONÍA)</h4>
						Nos comprometemos a usar el operador de larga distanciaqueustednosindique, para lo cual debe marcar el código de larga distanciadel operadorque elija.<br>
						<h4>COBRO POR RECONEXIÓN DEL SERVICIO</h4>
						En caso de suspensión del servicio por mora en el pago, podremos cobrarle un valor por reconexión que corresponderá estrictamente a los costos asociados a la operación de reconexión. Los valores de reconexiónpuedenvariar dependiendo de su estado actual.<br><br>
						En caso de servicios empaquetados procede máximo un cobro de reconexión por cada tipo de conexión empleado en la prestación de los servicios.

				</tr>
				<table border="1">
					<tr>
						<td colspan="2" style="background-color: black; color: white; font-size: x-large; text-align: justify; padding: 10px 20px">
						El usuario es el ÚNICO responsable por el contenido y la información que se curse a través de la red y del uso que se haga de los equipos o de los servicios.<br> 
						Los equipos de comunicaciones que ya no use son desechosqueno deben ser botados a la caneca, consulte nuestra política de recolección de aparatos en desuso.
						</td>
					</tr>
					<tr>
						<td colspan="2" style="text-align: justify">
							<h4>ESPACIO PARA LOS OPERADORES:</h4>
							Los equipos de comunicaciones y elementos consumibles a continuación relacionados se instalan en la vivienda del suscriptor y son entregados por Future Solutions Development S.A.S. encalidaddeComodato (Tenencia o Préstamo), por lo tanto, en el momento de la cancelación definitiva del servicio, los equipos y sus consumiblesseránretirados en su totalidad por la empresa.
							<table width="100%" border="1">
								<tbody>
									<tr style="border-radius: 20px">
										<td style="font-size: x-large">
				...
				<table border="1">
					...
					<tr>
						<td colspan="2" style="border: 0">Consulte el régimen de protección de usuarios en www.crcom.gov.co</h4>
						</td>
					</tr>
