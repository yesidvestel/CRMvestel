...
<script type="text/javascript">	
 ...
 tb=$('#clientstable').DataTable({
	...
	var barrio_Ninguno = new Array ("-","Palmeras","Pradera","Chapinero","Torres de San Sebastián","Gaviotas","La estrella","Paseo real","Esperanza","Villa del prado","Primavera","Nuevo milenio","San jose","Centro","Panorama","Alfonso lopez","Rivera de san andres","Rosales","Nuevo horizonte","La roca","Paomara","Floresta","Alcaravanes","Morichito","Villa santiago","15 de septiembre","Glorieta","Olimpico","Brisas del tua","Guaira","Esteros","Villa del bosque","Villa mariana","Guadalupe","Leche miel","Lanceros","Paraiso","El caney","Villa daniela","Julia luz","Los esteros");
