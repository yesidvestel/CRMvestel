...
<script type="text/javascript">	
	...
	var barrio_Ninguno = new Array ("-","PALMARES","PRADERA","ESPERANZA","VILLA DEL PRADO","PRIMAVERA","NUEVO MILENIO","SAN JOSE","CENTRO","PANORAMA","ALFONSO LOPEZ","RIVERAS DE SAN ANDRES","ROSALES","NUEVO HORIZONTE","LA ROCA","PAOMARE","FLORESTA","ALCARAVANES","MORICHITO","VILLA SANTIAGO","15 DE SEPTIEMBRE","GLORIETA","OLIMPICO","BRISAS DEL TUA","GUAIRA","ESTEROS","VILLA DEL BOSQUE","VILLA MARIANA","GUADALUPE","LECHE MIEL""LANCEROS","PARAISO","EL CANEY","VILLA DANIELA","JULIA LUZ","LOS ESTEROS");
