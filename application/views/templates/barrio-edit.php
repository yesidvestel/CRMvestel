    ...
    <div class="card card-block">
        ...
        <form method="post" id="data_form" class="form-horizontal">
            <div class="grid_3 grid_4">
                ...
                <h5>Modificar Barrio</h5>
                <hr>
                <input type="hidden" name="id" value="<?php echo $infobarrio['idBarrio'] ?>">
				<div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="depar"  id="depar"  class="form-control mb-1">
							<option value="<?php echo $infobarrio['idDepartamento'] ?>"><?php echo $infobarrio['departamento'] ?></option>
							<?php
				...
				<div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select  id="cmbCiudades"  class="selectpicker form-control" name="ciudad">
							<option value="<?php echo $infobarrio['idCiudad'] ?>"><?php echo $infobarrio['ciudad'] ?></option>
						</select>
                    </div>
                </div>
				<div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="amount">Localidad</label>

                    <div class="col-sm-6">
                        <select id="cmbLocalidades"  class="selectpicker form-control" name="localidad">
							<option value="<?php echo $infobarrio['idLocalidad'] ?>"><?php echo $infobarrio['localidad'] ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label" for="body"><?php echo $this->lang->line('') ?>Barrio</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Nombre del barrio"
                               class="form-control margin-bottom  required" name="barrio" value="<?php echo $infobarrio['barrio'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" value="templates/barrio_update" id="action-url">
                    </div>
                </div>
