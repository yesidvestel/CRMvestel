...
<button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="icon-minus-square"></i> </button>
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            <td colspan="2"><?php echo $this->lang->line('Reccuring Period') ?> <select name="reccur"
                                                                                                        class="selectpicker form-control">
                                    <option value="<?php echo $invoice['rec'] ?>">--<?php echo $invoice['rec'] ?>--
                                    </option>
                ...
                <input type="hidden" value="rec_invoices/editaction" id="action-url">
