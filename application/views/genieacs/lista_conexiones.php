...
<article class="content">
    ...
    <div class="card card-block">
        ...
        <h4>Configuracion de Conexiondes a Geniacs de Cada Sede </h4>
<a href="#" id="open_modal" class="btn-small btn-primary">Agregar Nueva Conexion</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="tipo">Agregar</span> Conexión</h4>
            </div>
            ...
            <div class="modal-body" id="emailbody">
                ...
                <tr>
                    <td>
                               <label>Puerto</label>
                                    <input required placeholder="Puerto" type="text" name="puerto" class="form-control">            
                        </td>
                        <td>
                            <label>Sede</label>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <textarea rows="10" id="comentarios" name="comentarios" class="form-control"></textarea>
                        </td>
...
<script type="text/javascript">
    ...
    $(document).on("click",".cl_calcula_estado",function(ev){
        ...
        mostrar_alerta1("notify",2,"Esperando Respuesta ...");
            $.post(baseurl+"/genieacs/estado_mikrotik",{'id':id_mk},function(data){
                mostrar_alerta1("notify",1,"Confirmado ");
                $("#notify").css("display","none");
                 tb.ajax.url( baseurl+"genieacs/list_json_conections").load();
            });
    });
    ...
    function consultar_estado (id){
            ...
            $.post(baseurl+"/genieacs/estado_mikrotik",{'id':lista_mks[id]},function(data){
                mostrar_alerta1("notify",1,"Confirmado ");
                $("#notify").css("display","none");
                 tb.ajax.url( baseurl+"genieacs/list_json_conections").load();
                 numer_iteration++;
    ...
    $(document).on("click",".set_default",function(ev){
        ...
        $.post(baseurl+"genieacs/set_default",datosx,function(dt){
            tb.ajax.url( baseurl+"genieacs/list_json_conections").load();    
        });
   ...
   $(document).on("submit","#form_guardar",function (e){
    e.preventDefault();
        ...
        $.post(baseurl+"genieacs/save_ajax_conection",form,function(data){
            tb.ajax.url( baseurl+"genieacs/list_json_conections").load();    
            document.getElementById("form_guardar").reset(); 
   ...
   $(document).on("click",".update_mk",function(e){
       ...
       $(document).on("click",".set_default",function(ev){
        ...
        $.post(baseurl+"genieacs/set_default_ips_user",datosx,function(dt){
            tb.ajax.url( baseurl+"genieacs/list_json_conections").load();    
        });
    ...
    $(document).ready(function(){
        ...
        tb=$('#tabla-historial').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('genieacs/list_json_conections')?>",
                "type": "POST"
            },
