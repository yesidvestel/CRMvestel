...
/* end codigo pagos adelantados*/
  ...
  if ($invoice['shipping'] > 0) { $cols++;}
    ...
    echo '</strong></td>
		...
		<div class="sign2">(' . $user . ')</div><div class="sign3">' . user_role($perfil) . '</div> <div class="terms"><hr>
		<strong>' . $this->lang->line('Terms') . ':</strong> ';
	...
	<table>
		...
		<tr>
			...
			<?php }elseif($this->config->item('ctitle')=='NETSMARTV'){ ?>
			<td align="center"><strong>LINEA ATE: 312 408 0876</strong></td>
			<?php }else{ ?>
			<td align="center">
				<strong>
