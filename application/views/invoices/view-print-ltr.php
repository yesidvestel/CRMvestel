  ...
  if ($invoice['shipping'] > 0) { $cols++;}
	...
	<table>
		<tr>
			...
			<td align="justify">Su servicio es prestado por <strong>NETSMARTV</strong>, Realice su pago a través de <strong>BANCOLOMBIA</strong> cuenta N° <strong>62900006671</strong> somos su mejor conexion.
			</td>
			<?php }else{ ?>
