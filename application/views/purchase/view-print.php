    ...
    <table>
        ...
        <tr>
            <td><h3><?php echo $this->config->item('ctitle'); ?></h3>
                <?php echo
                    $this->config->item('address') . '<br>' . $this->config->item('nit') . ',' . $this->config->item('nit') . '<br>' . $this->lang->line('Phone') . ': ' . $this->config->item('phone') . '<br> ' . $this->lang->line('Email') . ': ' . $this->config->item('email');
            ...
            <td>
                ...
                if ($invoice['company']) echo $invoice['nit'] . '<br>';
                echo $invoice['address'] . '<br>' . $invoice['city'] . '<br>Phone: ' . $invoice['nit'] . '<br>Email: ' . $invoice['email'];
