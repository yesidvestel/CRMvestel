...
class Cronjob_model extends CI_Model
{
    ...
    public function reports()
    {
        ...
        $query = $this->db->query("SELECT MONTH(date) AS month,YEAR(date) AS year,SUM(credit) AS income,SUM(debit) AS expense FROM transactions WHERE (YEAR(date)='$year') and type!='Transfer' and estado is null GROUP BY MONTH(date)");
