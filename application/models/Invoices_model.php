...
/* end codigo pagos adelantados*/
    ...
    public function get_servicios(){
        ...
        foreach($lista_sedes as $key=> $value){
            $lista_sedes[$key]['servicios_tv']=$this->db->get_where("products",array("pertence_a_tv_o_net"=>"Tv"))->result_array();
            $lista_sedes[$key]['servicios_internet']=$this->db->get_where("products",array("pertence_a_tv_o_net"=>"Internet"))->result_array();
