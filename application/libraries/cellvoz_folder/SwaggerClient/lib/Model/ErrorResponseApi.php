...
/**
 * ErrorResponseApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ErrorResponseApi implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorResponseApi';
...
'message' => 'getMessage'    ];
    ...
    {
        $this->container['succes'] = isset($data['succes']) ? $data['succes'] : false;
